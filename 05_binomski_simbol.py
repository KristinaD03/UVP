...
def binomski_fakulteta(n, k):
    binom = fakulteta(n) // (fakulteta(k) * fakulteta(n - k))
    return binom 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTAsInVzZXIiOjExNDI4fQ:1vzerW:qyw1xVLeY-QxO0-ZD8648Td72QEEZ9mQhGuqTYAGcaE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTEsInVzZXIiOjExNDI4fQ:1vzerW:1hnVKsBwgWBR1gNdL-RNqfvQjg4W-dl-_gaZq5lm3lA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTIsInVzZXIiOjExNDI4fQ:1vzerW:APVH1ODJVuFs05p2MHCKJkK3Pl7ZbcxbfNGi0iTHNbU"
        try:
