...
# =============================================================================
def ugibaj(n):
    vnos = preberi_celo_stevilo()
    if vnos == n:
        print(f'BRAVO! Res sem si zamislil število {vnos}!')
    elif vnos < n:
       print("Moje število je večje!")
       ugibaj(n)
    else:
        print("Moje število je manjše!")
        ugibaj(n) #dodamo ugibaj(n) da se funkcija sama pokliče in ponovno prevrja
# =====================================================================@027623=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NiwidXNlciI6MTE0Mjh9:1w2QfV:bymo_DKyPM7PeFXihOWIYRCqFe20J1RjOT8Yqo4JM40"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NywidXNlciI6MTE0Mjh9:1w2QfV:COZmjXXCUR82Ga2C79RoGdHiIC_S4f6NHlPfliBlqLk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyMywidXNlciI6MTE0Mjh9:1w2QfV:bPVmTeBUY2ZnzQaieq6F3DXVs8wQY6sj-rcwLkFG-2U"
        try:
