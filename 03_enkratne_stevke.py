...
def ali_ima_enkratne_stevke(n):
    if kolikokrat_se_pojavi_stevka(0, n) < 2:
        if kolikokrat_se_pojavi_stevka(1, n) < 2:
            if kolikokrat_se_pojavi_stevka(2, n) < 2:
                if kolikokrat_se_pojavi_stevka(3, n) < 2:
                    if kolikokrat_se_pojavi_stevka(4, n) <2:
                        if kolikokrat_se_pojavi_stevka(5, n) < 2:
                            if kolikokrat_se_pojavi_stevka(6, n) < 2:
                                if kolikokrat_se_pojavi_stevka(7, n) < 2:
                                    if kolikokrat_se_pojavi_stevka(8, n) < 2:
                                        if kolikokrat_se_pojavi_stevka(9, n) < 2:
                                            return True
                                        return False
                                    return False
                                return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTE0Mjh9:1vxQod:Xyy55ryVxuRTF85s0nLD-gLW9UyCqpLh7wEdGTOK5zA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTE0Mjh9:1vxQod:338A7wnspS_NIeK15PrAGBmfdbNdgWrcFZGeLSlr1uE"
        try:
